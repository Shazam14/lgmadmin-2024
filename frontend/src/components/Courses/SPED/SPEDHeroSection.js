        ...
        <section className="our-course-program">
          <div className="card-course-box">
            ...
            <p className="course-section-text">
              ...
              delays. Surprisingly, Therapy Centers and other schools with
              Special Education recommend LGMS as one of the best new
              environment for their clients/ students to further develop their
