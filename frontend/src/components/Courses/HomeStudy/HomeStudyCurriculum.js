      ...
      <div className="card-course-box">
        ...
        <div className="curriculum-grid">
          <div className="curriculum-item">
            ...
            <span className="course-section-text">Certificate for Sensory</span>
          </div>
          <div className="curriculum-item">
            <div className="icon">
              <svg viewBox="0 0 24 24">
            ...
            <span className="course-section-text">Mathematics</span>
          </div>
          <div className="curriculum-item">
            <div className="icon">
              <svg viewBox="0 0 24 24">
            ...
            <span className="course-section-text">Practical Application</span>
          </div>
          <div className="curriculum-item">
            <div className="icon">
              <svg viewBox="0 0 24 24">
            ...
            <span className="course-section-text">Sensory Achievement</span>
          </div>
        </div>
      </div>
    </section>
